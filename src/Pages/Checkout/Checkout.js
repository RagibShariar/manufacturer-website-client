...
const Checkout = () => {
    return (
        <div className=' mt-16'>
            ...
            <div className="container min-w-screen min-h-screen bg-gray-50 py-5">
                <div className="px-5">
                    <div className="mb-2">
                        <Link to="/cart" className="focus:outline-none hover:underline text-gray-500 text-sm"><i className="mdi mdi-arrow-left text-gray-400"></i>Back</Link>
                    </div>
                    <div className="mb-2">
                            ...
                            <div className="px-3 md:w-5/12">
                                <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-3 text-gray-800 font-light mb-6">
                                    ...
                                    <div className="w-full flex mb-3 items-center">
                                        ...
                                        <div className="flex-grow pl-3">
                                        <input disabled type="text" placeholder="Name" className="input input-bordered input-sm w-full max-w-xs" />
                                        </div>
                                    </div>
                                    {/* phone number */}
                                    <div className="w-full flex mb-3 items-center">
                                    ...
                                    <div className="w-full flex items-center">
                                        ...
                                        <div className="flex-grow pl-3">
                                        <input type="text" placeholder="Address" className="input input-bordered input-sm w-full max-w-xs" />
                                        </div>
                                    </div>
                                </div>
