    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        <div class="flex items-center  -mx-8 px-6 py-5">
          ...
          <div class="flex justify-center w-1/5">
            ...
            <input class="mx-1 rounded-lg border border-gray-400 text-center w-12  text-base font-semibold" type="text" value="55"/>
      ...
      <div id="summary" class="w-1/4 px-8 py-10">
        ...
        <div class="border-t mt-8">
          ...
          <Link to="/checkout" class="btn border-0 bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</Link>
        </div>
      </div>
