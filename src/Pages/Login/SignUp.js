...
const SignUp = () => {
    ...
    <div className="mt-16 w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md">
        ...
        <form className="mt-6">
            ...
            <div className="mt-6">
                <button disabled={!checked} type="submit"
                    className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-600 rounded-md hover:bg-gray-700 disabled:opacity-75 ">
                    Sign Up
                </button>
            </div>
        </form>
        ...
        <a href="#" className=" w-full flex items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg  dark:hover:bg-slate-200" >
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-400"> Already have an account? <a href="#"
                className="font-medium text-gray-700  hover:underline">Login</a></p>
    </div>
        </div>
    );
};
