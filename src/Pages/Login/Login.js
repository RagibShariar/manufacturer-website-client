...
const Login = () => {
    ...
    <div className="mt-16 w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md">
        ...
        <button onClick={handleSignInWithGoogle} className=" w-full flex items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg  dark:hover:bg-slate-200" >
